...
function Veiculo() {
  ...
  function getVeiculos() {
    axios.get('https://woebegone-silk-production.up.railway.app/veiculos').then(
      result => {
  ...
  function setmanutencao(){
    axios.post('https://woebegone-silk-production.up.railway.app/manutencoes/'+idselectveichle,cadastromanut).then(result=>{
      console.log(result.data);
