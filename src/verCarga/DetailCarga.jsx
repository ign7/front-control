...
function DeitailCarga() {
    ...
    function getcargasbyentrega() {
        axios.get('https://woebegone-silk-production.up.railway.app/entregas/' + id).then(result => {
    ...
    function savedespesa(){
        axios.post('https://woebegone-silk-production.up.railway.app/despesas/'+idcargadespesaselect,cadastrodespesa).then(result=>{
   ...
   /*  function deletecargabyid(iddeletecarga){
      axios.delete('https://woebegone-silk-production.up.railway.app/cargas/'+iddeletecarga).then(result=>{
          console.log("delete");
          //getcargasbyentrega();
      })
    } */
